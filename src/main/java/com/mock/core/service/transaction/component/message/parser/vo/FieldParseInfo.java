...
public class FieldParseInfo {
     ...
     * 
     * */
    public FieldParseInfo(Integer fieldid, Type t, int len, String nam, String defVal, boolean pos, boolean unq) {
        if (t == null) {
     ...
     * 
     * @param unique value to be assigned to property unique
     */
