...
import com.mock.core.service.transaction.util.CipherOperator;
import com.mock.core.service.transaction.util.Converts;
import com.mock.core.service.transaction.util.MacGenerer4PingAn;
...
public class Message {
    ...
    public int estimatetotalmsglength() {
        ...
        if (StringUtil.isNotBlank(msgTypeId)) // 报文类型标示
