...
import com.mock.core.service.transaction.component.message.specific.BytesMacGenerater;

/**
 * 工作密钥解密
 * 
 * @author hongliang.ma
 * @version $Id: WorkKeyDecrypt.java, v 0.1 2012-6-29 下午1:15:47 hongliang.ma Exp $
 */
public final class WorkKeyDecrypt {
    private static final Logger logger           = Logger.getLogger(WorkKeyDecrypt.class);
    ...
    public static byte[] generateDecryptWorkKey(byte[] workKey) {
        ...
        // return getDecryptMainKeyBytes(checkData, tmpBuffer, 8);
    }
