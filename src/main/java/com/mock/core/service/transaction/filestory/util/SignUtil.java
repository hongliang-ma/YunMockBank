...
public class SignUtil {
     ...
     * @throws Exception 
     */
    public static String sign(String src, Resource priiKey) {
        String RSA_ALGORITHM_NAME = "RSA";
        SignManagerImpl signManager = new SignManagerImpl();
        PrivateKey priKey = KeyUtil.getMOCKPriKey(priiKey);
    ...
    public static boolean check(Document doc, PublicKey pubKey) {
        try {
            ...
            XMLSignature signature = new XMLSignature(signElement, doc.getNamespaceURI());
    ...
    public static String sign(Document doc, PrivateKey privateKey, String msgType) {
        try {
            ...
            XMLSignature sig = new XMLSignature(doc, doc.getNamespaceURI(),
