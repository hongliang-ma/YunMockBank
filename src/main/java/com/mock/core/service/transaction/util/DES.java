...
public class DES {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // System.out.println(Converts.bytesToHexString(DES.ECBdecrypt(Converts.hexStringToBytes("61522CC42A2438E4"),

            // System.out.print("CBC mode:");
            // data = DES.CBCEncrypt(buf, key, iv);
            // System.out.print(Converts.bytesToHexString(data)+"==");
            // System.out.println(Converts.bytesToHexString(DES.CBCDecrypt(data,
            // key, iv)));
            // String hex8 = Converts.bytesToHexString(data).substring(0, 16);
            // System.out.println("第一次加密需要异或:" + hex8);
            // byte[] des1 = Converts.hexStringToBytes(hex8);
            // // toZipBcd(hex8, des1);
            // // System.arraycopy(data, 0, des1, 0, 8);
            // byte[] asc = new byte[8];
            // toBcd("ACCEE008", asc);
            // MacGenerer4PingAn.doXor(des1, asc);
            // System.out.println(Converts.bytesToHexString(des1));
            // byte[] datafinal = DES.ECBencrypt(des1, key);
            // System.out.println(Converts.bytesToHexString(datafinal));
            // String finalmac =
            // Converts.bytesToHexString(datafinal).substring(0, 8);
            // // .substring(0, 8);
            // System.out.println(Converts.StringToHexString(finalmac));
