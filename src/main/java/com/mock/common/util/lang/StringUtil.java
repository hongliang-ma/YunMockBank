...
import com.mock.common.util.ByteConstant;
 ...
 * @author peng.lanqp
 * @author 松雪
 * @version $Id: StringUtil.java, v 0.2 2012-1-30 下午1:48:50 hao.zhang Exp $
 */
public class StringUtil extends com.alibaba.common.lang.StringUtil {
	...
	public static String[] cutString(String message, int length) {
		...
		return new String[] {
				normal,
				com.alibaba.common.lang.StringUtil.substringAfter(message,
						normal) };
	}
	...
	public static String fillLength(String input, int lengthLength) {
		...
		String filledLength = com.alibaba.common.lang.StringUtil.alignRight(
	...
	/**
	 * 根据url获取系统名称 如果url里面包括系统名就返回，否则直接返回域名 如http://bops.alipay.com 返回bops
	...
	public static boolean isContainChinese(String message, int length) {
		...
		char[] charsPlus = StringUtil.substrings(message, 0, length + 1)
				.toCharArray();
